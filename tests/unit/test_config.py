...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["learning_rate_scheduler", "import"], None, False),
        (["learning_rate_scheduler", "params"], None, True),
        (["learning_rate_scheduler", "extra"], "param", False),
        (["learning_rate_scheduler"], {"import": "my_s", "params": {"a": 0.9}}, True),
